...
public class SigupDetailsPage extends MainPage {
  ...
  public void waitfordetailtittle() {
	...
	public void waitformonth() {
	    wait.until(ExpectedConditions.visibilityOf(monthchoice));
	}

	public void waitforyear() {
	    wait.until(ExpectedConditions.visibilityOf(yearchoice));
	}
  
  public void details(String userpass, String first, String last, String usercompany,String useraddress,String userstate,String usercity,
